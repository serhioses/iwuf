...
var _eclipse = __webpack_require__(2);
...
var Module = function () {
  ...
  _createClass(Module, [{
    ...
    value: function extend(extender) {
      if (_eclipse2.default.helpers.getClass(extender) === 'Object') {
        _jquery2.default.extend(true, this.state, extender);
      }
    }
  }, {
    key: 'alias',
    get: function get() {
      return _storage2.default.alias;
    }
  }]);
...
var common = new _module2.default('common');

_eclipse2.default.UI.Bundle.onClickOutside();

common.createBundle = function (trigger, close, options) {
  if (!trigger.length) {
    return { init: _jquery2.default.noop };
  }

  return new _eclipse2.default.UI.Bundle(trigger, close, options);
};
...
_common2.default.createBundle((0, _jquery2.default)('.menu-trigger'), '', {
  container: (0, _jquery2.default)('.side-menu'),
  overlay: (0, _jquery2.default)('.overlay--menu')
}).init();
