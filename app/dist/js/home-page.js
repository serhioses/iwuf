...
var _fancybox = __webpack_require__(10);
...
modal.launch = function (settings, el) {
  if (typeof el !== 'undefined' && el.length) {
    el.fancybox(_jquery2.default.extend(true, {}, MODAL_SETTINGS, settings));
  } else {
    _jquery2.default.fancybox(_jquery2.default.extend(true, {}, MODAL_SETTINGS, settings));
  }
};
...
slider.createSlider = function (id, settings) {
  ...
  return (0, _jquery2.default)(id).slick(_jquery2.default.extend(true, {}, SLIDER_SETTINGS, settings));
};

slider.setCurrentThumb = function (idx) {
  slider.state.thumbs.removeClass('js-thumb--active').eq(idx).addClass('js-thumb--active');
};
...
slider.createThumbs = function (id, settings) {
  ...
  return (0, _jquery2.default)(id).slick(_jquery2.default.extend(true, {}, THUMBS_SETTINGS, settings));
};
...
var body = _slider2.default.alias.body,
    sliderEl = (0, _jquery2.default)('#slider'),
    thumbs = (0, _jquery2.default)('.js-thumb'),
    animationFinished = true;

_slider2.default.extend({
  thumbs: thumbs
});

_slider2.default.createSlider('#slider', {
  dots: true,
  arrows: false
});

sliderEl.on('swipe', function (e, slick) {
  _slider2.default.setCurrentThumb(slick.currentSlide);
  animationFinished = false;
});
sliderEl.on('beforeChange', function (slick, currentSlide, nextSlide) {
  _slider2.default.setCurrentThumb((nextSlide + 1) % currentSlide.slideCount);
  animationFinished = false;
});
...
body.on('click', '.js-thumb', function (e) {
  ...
  if (animationFinished) {
    sliderEl.slick('slickGoTo', (0, _jquery2.default)(this).index());
    _slider2.default.setCurrentThumb((0, _jquery2.default)(this).index());
  }
});
